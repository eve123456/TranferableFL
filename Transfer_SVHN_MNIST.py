...
# ft_trn_main(model_flag, options, device,train_loader, test_loader, criterion)

# Train model_target_only
print(f"Training model_target_only...")
ft_trn_main(model_target_only, options, device,train_loader, test_loader, criterion)

# # Train model_ft
# print(f"Training model_ft...")
# ft_trn_main(model_ft, options, device,train_loader, test_loader, criterion)
...
# res_sc_only[0], res_sc_only[1] = ft_eval(model_source_only,device,test_loader, criterion)
