...
class Client(object):
    ...
    def set_BASE_model_params(self, model_params_dict):
        """Set model parameters"""
        self.worker.set_BASE_model_params(model_params_dict)
    ...
    def set_flat_BASE_model_params(self, flat_params):
        self.worker.set_flat_BASE_model_params(flat_params)
    ...
    def local_train(self, RegPole_NORM=None, RegPole=None, **kwargs):
        ...
        local_solution, worker_stats = self.worker.local_train(self.train_dataloader, 
                                                               RegPole_NORM = RegPole_NORM,
                                                               RegPole = RegPole, **kwargs)
        end_time = time.time()
        bytes_r = self.worker.model_bytes
    ...
    def BASE_local_train(self, **kwargs):
        """Solves local optimization problem
        ...
        Returns:
            ...
            2. Statistic Dict contain
                ...
                2.4: other stats in train process
        """
        local_solution = self.worker.BASE_local_train(self.train_dataloader, **kwargs)
