...
class Client(object):
    ...
    def local_train(self, last_round_avg_local_grad_norm=None, last_round_global_grad=None, **kwargs):
        ...
        local_solution, worker_stats = self.worker.local_train(self.train_dataloader, 
                                                               last_round_avg_local_grad_norm=last_round_avg_local_grad_norm,
